...
class __TwigTemplate_14f25d4e7d65f08cb3a80a2f0618f720 extends Template
{
    private $source;
    private $macros = [];
...
{% else %}
  {{ content }}
{% endif %}
", "modules/contrib/webform/templates/webform-composite-name.html.twig", "/var/www/html/website/web/modules/contrib/webform/templates/webform-composite-name.html.twig");
    }
